        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "𝐬𝐨𝐮𝐫𝐜𝐞 𝐒𝐀𝐅𝐈𝐍𝐀 ➺🐼", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "𝐒𝐀𝐅𝐈𝐍𝐀 ➺", url="https://t.me/S_F_M_1"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("𝐒𝐀𝐅𝐈𝐍𝐀 ➺", url=f"https://t.me/S_F_M_1"),
                InlineKeyboardButton(
                    "𝐬𝐨𝐮𝐫𝐜𝐞 𝐒𝐀𝐅𝐈𝐍𝐀 ➺🐼", url=f"https://t.me/INTERNETFREE8"
                ),
            ]
        ]
    )
